...
# script_name = "plot_metrics_reduced_species.py"
...
figure_path = os.path.join(out_dir, 'nr_sig_terms_per_user_input_reduced_species.svg')
...
figure_path = os.path.join(out_dir, 'at_least_one_significant_facetGrid_reduced_species.svg')
...
figure_path = os.path.join(out_dir, 'at_least_one_significant_facetGrid_vertical_reduced_species.svg')
h.fig.savefig(figure_path, metadata = fig_metadata, bbox_inches = 'tight')
h.fig.savefig(as_png(figure_path), metadata = fig_metadata, bbox_inches = 'tight')
