...
_, sigTermDf_file, hsa_members_file, taxId, gene_unions_by_term_size_file, summary_cum_gene_unions_file = sys.argv
...
species       = df.species.iloc[0]       # e.g. 'H.sapiens'
species_group = df.species_group.iloc[0] # e.g.'Homo sapiens'
...
cum_gene_unions_by_term_size = uniquify_thresholded(gene_unions_by_term_size_added_missing)
...
cgubts_group = cum_gene_unions_by_term_size.groupby(grouping_columns, as_index = False)
